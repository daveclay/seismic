 ...
 */
public class StandardSerialIO implements SerialPortEventListener, SerialIO {
     ...
     */
    public StandardSerialIO(int baudRate){
     ...
     */
    public StandardSerialIO(String portName) {
        this(portName, 9600, 'N', 8, 1);
    }


    public StandardSerialIO(String portName, int baudRate) {
    ...
    /**
     * Used by SerialListener to shut things down.
     */
    public void dispose() {
        stop();
    }
